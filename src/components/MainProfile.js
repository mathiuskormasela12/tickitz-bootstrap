        ...
        <Container>
          <Row>
              ...
              <Card style={{ borderRadius: "1rem", color: "#14142B" }} className="border-0">
                <Card.Header style={{ borderTopLeftRadius: "1rem", borderTopRightRadius: "1rem" }} className="bg-white p-5">
                  ...
                  <div className="text-center">
                    <img src={User} alt="user" className="img-fluid rounded-circle"/>
            ...
            <Col md={8} className="mt-4 mt-md-0">
              <Card style={{ borderRadius: "1rem", color: "#14142B" }} className="border-0">
                <Card.Body>
                  <Nav defaultActiveKey="account-settings" onSelect={currentPage => setSelectedPage(currentPage)}>
                    <Nav.Item className="navbar-item">
                      <Nav.Link eventKey="account-settings" className="text-muted">Account Settings</Nav.Link>
                    </Nav.Item>
                    <Nav.Item className="navbar-item">
                      <Nav.Link eventKey="order-history" className="text-muted">Order History</Nav.Link>
                    </Nav.Item>
                  </Nav>
                </Card.Body>
              </Card>
