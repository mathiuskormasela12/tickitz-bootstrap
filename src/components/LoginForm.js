...
function LoginForm() {
  ...
  return (
    <React.Fragment>
      <div className="col-xl-5 col-lg-6 col-sm-12 col-md-12">
        <div className="container">
          <div className="row">
            <div className="col-xl-12">
              <h3 className="fs-1 form-title mb-3">Sign In</h3>
            ...
            <div className="col-xl-12 mt-4">
              <form>
                <div className="mb-4">
                  ...
                  <input type="email" className="form-control input-signin" id="email" placeholder="Write your email" autoComplete="off" />
                </div>
                <div className="mb-4 position-relative">
                  <label htmlFor="password" className="form-label text-label">
                    Password
                  </label>
                  <div className="img-eye" id="eye" onClick={showPassword}>
                  ...
                  <input type={(state.show) ? 'text' : 'password'} className="form-control input-signin" id="password" placeholder="Write your password" />
                </div>
                <div className="d-grid gap-2 mt-5">
                  <button type="button" className="btn btn-lg btn-signin">Sign In</button>
                </div>
              </form>
            </div>
            <div className="col-xl-12 mt-4 forgot-col">
              <p className="text-center">
                Forgot your password? <Link to="/forgot" className="text-reset">Reset now</Link>
              </p>
            </div>
